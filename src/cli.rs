...
pub struct Cli {
    ...
    #[arg(short = 'n', long)]
    pub dry_run: bool,
    /// Print a versioned machine-readable response. Dry runs return a plan, --test-only returns
    /// scheduler feedback, and batch submissions return a Slurm job identifier. JSON mode does
    /// not support interactive jobs.
    #[arg(long)]
    pub json: bool,
